...
<form action="{{ route('experts.store') }}" method="POST">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-2">
            ...
            <input type="text" name="birthday" class="form-control date" id="birthday">
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-3">
            ...
            <input type="text" name="assessment1" class="form-control" id="assessment1">
        </div>
        <div class="form-group col">
    ...
    <div class="form-row">
        <div class="form-group col-3">
            ...
            <input type="text" name="assessment2" class="form-control" id="assessment2">
        </div>
        <div class="form-group col">
            <label for="result2">Resultado</label>
            <input type="text" name="result2" class="form-control" id="result2">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-3">
            <label for="assessment3">Evaluado en</label>
            <input type="text" name="assessment3" class="form-control" id="assessment3">
        </div>
        <div class="form-group col">
            ...
            <div class="form-row">
                ...
                <div class="col-9">
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="{{$key}}" id="{{$key}}u" value="unknown">
                        <label class="form-check-label" for="{{$key}}u">No lo manejo</label>
                    </div>
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="{{$key}}" id="{{$key}}b" value="basic">
                        <label class="form-check-label" for="{{$key}}b">Básico</label>
                    </div>
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="{{$key}}" id="{{$key}}i" value="intermediate">
                        <label class="form-check-label" for="{{$key}}i">Intermedio</label>
                    </div>
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="{{$key}}" id="{{$key}}a" value="advanced">
