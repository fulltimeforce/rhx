    ...
    $(document).ready(function (ev) {
      ...
      function tablebootstrap_filter( data ){
        var columns = [
            ...
            },
            {
              ...
              width: 20,
              formatter : function(value,rowData,index) {    
                  var actions = '<a class="badge badge-primary recruit-call" data-phonecall="approve" data-positionid="'+rowData.position_id+'" data-id="'+rowData.id+'" href="#">YES</a>'+
                                ' <a class="badge badge-danger recruit-call" data-phonecall="disapprove" data-positionid="'+rowData.position_id+'" data-id="'+rowData.id+'" href="#">NO</a>'
      ...
      $('#search-recruit').on('click' , function(){
        ...
        window.history.replaceState({
            edwin: "Fulltimeforce"
            }, "Page" , "{{ route('recruit.outstanding') }}" + '?'+ $.param(
                {   search : true , 
                    name: search_name
                }
                )
