...
<!--  
        /*========================================== FCE ==========================================*/
    -->
<div class="modal fade" id="fceRecruit" tabindex="-1" role="dialog" aria-labelledby="fceRecruitLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="fceRecruitLabel">FCE - <span id="fce_recruit_name"></span></h5>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <table id="list-audios" class="table table-dark mb-5">
                    <thead>
                        <tr>
                            <th><span id="audio_recruit_name"></span></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
    ...
    $(document).ready(function () {
            ...
            $("table tbody").on('click' , 'a.btn-fce' , function(ev){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        var html='';
                        $("#audio_recruit_name").html( _data.recruit.fullname );
                        ...
                        $("input:radio[name=grammatical_forms]").filter('[value='+_data.recruit.grammatical_forms+']').prop('checked', true);
                        $("input:radio[name=vocabulary]").filter('[value='+_data.recruit.vocabulary+']').prop('checked', true);
                        $("input:radio[name=stretch_language]").filter('[value='+_data.recruit.stretch_language+']').prop('checked', true);
                        $("input:radio[name=cohesive_devices]").filter('[value='+_data.recruit.cohesive_devices+']').prop('checked', true);
                        $("input:radio[name=hesitation]").filter('[value='+_data.recruit.hesitation+']').prop('checked', true);
                        $("input:radio[name=organizations_ideas]").filter('[value='+_data.recruit.organizations_ideas+']').prop('checked', true);
                        $("input:radio[name=intonation]").filter('[value='+_data.recruit.intonation+']').prop('checked', true);
                        $("input:radio[name=phonological_features]").filter('[value='+_data.recruit.phonological_features+']').prop('checked', true);
                        $("input:radio[name=intelligible]").filter('[value='+_data.recruit.intelligible+']').prop('checked', true);
                        $("input:radio[name=interaction]").filter('[value='+_data.recruit.interaction+']').prop('checked', true);
                        ...
                        $("#fce_recruit_name").html(_data.recruit.fullname);
        ...
        $('#search').on('click' , function(){
            ...
            window.history.replaceState({
                edwin: "Fulltimeforce"
                }, "Page" , "{{ route('recruit.fce.menu') }}" + '?'+ $.param(
                    {   search : true , 
                        name: search_name
                    }
                    )
